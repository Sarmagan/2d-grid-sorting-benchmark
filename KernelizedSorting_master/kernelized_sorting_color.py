...
from scipy.optimize import linear_sum_assignment # <-- Replaced hungarian
# import lapjv
# import pdb
...
def KS(X_1,X_2):
    ...
    for i in range(n_iter):
        ...
        # It returns (row_indices, column_indices)
        row_ind, indexes = linear_sum_assignment(cost_matrix)
        # 'indexes' is the permutation array you need
...
if __name__=='__main__':
    # You will need to define a main() function
    # or add test code here for this to run.
    print("Code updated. Define main() to run.")
    # main()